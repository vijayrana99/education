  ...
  return (
    <div className="space-y-6">
      <div className="mb-6">
        ...
        <p className="text-slate-600 dark:text-slate-400">Welcome back! Here is what is happening with your school website.</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {statsCards.map((card, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white dark:bg-slate-900 rounded-lg shadow-sm border border-slate-200 dark:border-slate-800 p-6 hover:shadow-md transition-shadow"
              >
